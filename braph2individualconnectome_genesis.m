...
rollcall = { ...
    ...
    '+analysis', '+_AnalyzeEnsemble.gen.m', '+_AnalyzeEnsemblePP_GDict.gen.m', '+_AnalyzeEnsemblePP_MeDict.gen.m', '+_CompareEnsemble.gen.m', '+_CompareEnsemblePP_CpDict.gen.m', ...
        ...
        '+_PanelPropCellFDR.gen.m','+_AnalyzeGroup.gen.m' ...
    '-nn', ...
    '+gui*', '-gui_examples', ...
    '+brainsurfs*', ...
    '+atlases*', ...
    ...
    '+pipelines', ...
        ...
        '+Individualconnectome*','+functional*','+structural*', ...
    '+test*', ...
    '-sandbox' ...
    };
...
if ~exist(target_dir, 'dir') 
    ...
    for i = 6:numel(new_element_gen_list) % Loop through and test each new element
