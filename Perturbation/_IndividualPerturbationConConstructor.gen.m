%% ¡header!
IndividualPerturbationConConstructor < IndividualConConstructorBase (icdd, deviation-based subject individual brain connectome Constructor) Construct deviation based brain connecome from subjects with nifti files.

%%% ¡description!
IndividualPerturbationConConstructor imports a group of subjects with regional SUVR  
...
%%%% ¡default!
'IndividualPerturbationConConstructor imports a group of subjects with connectivity data from a series of XLS/XLSX file. The variables of interest can be loaded from another XLS/XLSX file.'
...
Example data
%%%% ¡code!
group_dir = fullfile(fileparts(which('IndividualPerturbationConConstructor')),'Example data Nifti');
if ~exist(group_dir)
...
group_dir = fullfile(fileparts(which('IndividualPerturbationConConstructor')),'Example data Nifti', 'Group1');
...
healthy_dir = fullfile(fileparts(which('IndividualPerturbationConConstructor')),'Example data Nifti', 'Group2');
