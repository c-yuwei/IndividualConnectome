%% ¡header!
ConstructorIndividualConBase < ConcreteElement (base, Individual Base Constructor) is the base constructor for individual brain connectome.
