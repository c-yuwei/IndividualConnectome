...
gr1_div  = a_WU1.get('G_DICT');
gr2_div  = a_WU2.get('G_DICT');
gr3_div  = a_WU3.get('G_DICT');
gr4_div  = a_WU4.get('G_DICT');
...
for i = 1:length(sub_list_MCI)
    A = gr2_div.get('IT_LIST');
    connectome_matrix = A{i}.get('A');
    connectome_matrix = connectome_matrix{1};
...
save('Results/matrix/withConverters/classification_DivergenceMultiplexWU_SUVR_Balanced(CN pos).mat', 'results');
