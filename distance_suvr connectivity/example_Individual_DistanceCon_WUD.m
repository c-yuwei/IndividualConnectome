...
densities = 5;
graph_temp = MultigraphWUD('DENSITIES', densities);
a_WUD1 = AnalyzeEnsemble_CON_WUD( ...
    'GRAPH_TEMPLATE', graph_temp, ...
    'GR', Con_gr1 ...
    );

a_WUD2 = AnalyzeEnsemble_CON_WUD( ...
    'TEMPLATE', a_WUD1, ...
    'GR', Con_gr2 ...
    );

a_WUD3 = AnalyzeEnsemble_CON_WUD( ...
    'TEMPLATE', a_WUD1, ...
    'GR', Con_gr3 ...
    );

a_WUD1.memorize('G_DICT')
a_WUD2.memorize('G_DICT')
a_WUD3.memorize('G_DICT')
