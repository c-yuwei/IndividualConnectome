%EXAMPLE_CORRELATION_PDFS_2_CON
...
%% Analyze SubjectFUN data as weighted undirected connectivity
...
%% Convert PDFs to connectivity using correlation
c = ConverterPDFs2CON( ...
    'GR_PDFS', gr_pdfs, ...
    'METHOD', 'correlation' ...
    );
...
%% Export data
directory_base = [fileparts(which('example_correlation_PDFs_2_CON')) filesep 'Converted CON data'];
