%% ¡header!
ConverterNeuroimaging2RegionalValues < ConcreteElement (cn, converter of neuroimaging data to regional values) converts subject-level NIfTI neuroimaging data into regional values.
...
%%% ¡seealso!
Group, SubjectNeuroimaging, SubjectST, BrainAtlas, BrainRegion, ImporterGroupSubjectNeuroimaging_NIfTI, ExporterGroupSubjectST_XLS, ExporterBrainAtlasXLS
...
%%% ¡prop!
ELCLASS (constant, string) is the class of the converter of neuroimaging data to regional values.
%%%% ¡default!
'ConverterNeuroimaging2RegionalValues'

%%% ¡prop!
NAME (constant, string) is the name of the converter of neuroimaging data to regional values.
%%%% ¡default!
'Neuroimaging-to-Regional-Values Converter'

%%% ¡prop!
DESCRIPTION (constant, string) is the description of the converter of neuroimaging data to regional values.
%%%% ¡default!
'ConverterNeuroimaging2RegionalValues converts subject-level NIfTI neuroimaging data into regional values using atlas-defined brain regions, optional anatomical masks, and optional reference-region normalization.'

%%% ¡prop!
TEMPLATE (parameter, item) is the template of the converter of neuroimaging data to regional values.
%%%% ¡settings!
'ConverterNeuroimaging2RegionalValues'

%%% ¡prop!
ID (data, string) is a few-letter code for the converter of neuroimaging data to regional values.
%%%% ¡default!
'ConverterNeuroimaging2RegionalValues ID'

%%% ¡prop!
LABEL (metadata, string) is an extended label of the converter of neuroimaging data to regional values.
%%%% ¡default!
'ConverterNeuroimaging2RegionalValues label'

%%% ¡prop!
NOTES (metadata, string) are some specific notes about the converter of neuroimaging data to regional values.
%%%% ¡default!
'ConverterNeuroimaging2RegionalValues notes'
...
%%% ¡prop!
GR_ST (result, item) is the group of subjects with regional values.
%%%% ¡settings!
'Group'
%%%% ¡calculate!
ba_list = cn.get('BA_LIST');
...
%%% ¡test!
%%%% ¡name!
Sanity check - convert GM probability NIfTI data to regional values
%%%% ¡probability!
.01
%%%% ¡code!
...
%%% ¡test!
%%%% ¡name!
Sanity check - convert PET NIfTI data to SUVR regional values
%%%% ¡probability!
.01
%%%% ¡code!
example_data_dir = fullfile(fileparts(which('ConverterNeuroimaging2RegionalValues')), 'Example data NIfTI');
