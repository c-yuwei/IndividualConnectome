%% ¡header!
ConverterNeuroimaging2RegionalValuesPP_BR_DICT < PanelProp (pr, graph and measure plot) plots the panel to manage the graph and measures of an ensemble analysis.
