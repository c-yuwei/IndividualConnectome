...
%% Connectivity classification: correlation-based PDF connectomes
...
result_table = table( ...
    ...
    'VariableNames', {'Comparison', 'Mean_AUC', 'STD_AUC', 'CI95_AUC'} ...
    );
...
out_dir = [fileparts(which('hang_NNCV_PET_ST_CLA.m')) filesep 'PDF_connectivity_classification_results'];

if ~exist(out_dir, 'dir')
    mkdir(out_dir)
end

save(fullfile(out_dir, 'SUVR_correlation_connectivity_CLA_results.mat'), ...
    'number_runs', ...
    'kfolds', ...
    'ad_cn_auc', ...
    'ad_mci_auc', ...
...
writetable(result_table, fullfile(out_dir, 'PDF_correlation_connectivity_CLA_summary.csv'));
...
%MAKE_KFOLD_SPLIT_INDEX Creates reproducible BRAPH2-compatible split indices.
%
