...
im_gr_pet = ImporterGroupSubjectNeuroimaging_NIfTI( ...
    'DIRECTORY', [fileparts(which('SubjectNeuroimaging')) filesep 'Example data NIfTI' filesep 'Group1'], ...
    'MODALITY', 'pet', ...
    'TARGET', '', ...
    'WAITBAR', true ...
    );
...
im_gr_pet = ImporterGroupSubjectNeuroimaging_NIfTI( ...
    'DIRECTORY', [fileparts(which('SubjectNeuroimaging')) filesep 'Example data NIfTI' filesep 'Group2'], ...
    'MODALITY', 'pet', ...
    'TARGET', '', ...
    'WAITBAR', true ...
    );
