classdef ConverterNeuroimaging2PDFs < PanelProp
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = subclasses('ConverterNeuroimaging2PDFs', [], [], true);
		end
		function prop_list = getProps(category)
			...
			if nargin == 0
				prop_list = [ ...
					PanelProp.getProps() ...
						ConverterNeuroimaging2PDFs.TABLE_HEIGHT ...
						ConverterNeuroimaging2PDFs.SELECTED ...
						ConverterNeuroimaging2PDFs.TABLE ...
						ConverterNeuroimaging2PDFs.CONTEXTMENU ...
						];
				return
			end
		...
		function prop_number = getPropNumber(varargin)
			...
			prop_number = numel(ConverterNeuroimaging2PDFs.getProps(varargin{:}));
		end
		function check_out = existsProp(prop)
			...
			check = any(prop == ConverterNeuroimaging2PDFs.getProps());
			
			if nargout == 1
				check_out = check;
			elseif ~check
				error( ...
					[BRAPH2.STR ':ConverterNeuroimaging2PDFs:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':ConverterNeuroimaging2PDFs:' BRAPH2.WRONG_INPUT '\n' ...
		...
		function check_out = existsTag(tag)
			...
			converterneuroimaging2pdfs_tag_list = cellfun(@(x) ConverterNeuroimaging2PDFs.getPropTag(x), num2cell(ConverterNeuroimaging2PDFs.getProps()), 'UniformOutput', false);
			check = any(strcmp(tag, converterneuroimaging2pdfs_tag_list));
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				converterneuroimaging2pdfs_tag_list = cellfun(@(x) ConverterNeuroimaging2PDFs.getPropTag(x), num2cell(ConverterNeuroimaging2PDFs.getProps()), 'UniformOutput', false);
				prop = find(strcmp(pointer, converterneuroimaging2pdfs_tag_list)); % tag = pointer
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case ConverterNeuroimaging2PDFs.TABLE_HEIGHT
						tag = ConverterNeuroimaging2PDFs.TABLE_HEIGHT_TAG;
					case ConverterNeuroimaging2PDFs.SELECTED
						tag = ConverterNeuroimaging2PDFs.SELECTED_TAG;
					case ConverterNeuroimaging2PDFs.TABLE
						tag = ConverterNeuroimaging2PDFs.TABLE_TAG;
					case ConverterNeuroimaging2PDFs.CONTEXTMENU
						tag = ConverterNeuroimaging2PDFs.CONTEXTMENU_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case ConverterNeuroimaging2PDFs.TABLE_HEIGHT
					prop_category = ConverterNeuroimaging2PDFs.TABLE_HEIGHT_CATEGORY;
				case ConverterNeuroimaging2PDFs.SELECTED
					prop_category = ConverterNeuroimaging2PDFs.SELECTED_CATEGORY;
				case ConverterNeuroimaging2PDFs.TABLE
					prop_category = ConverterNeuroimaging2PDFs.TABLE_CATEGORY;
				case ConverterNeuroimaging2PDFs.CONTEXTMENU
					prop_category = ConverterNeuroimaging2PDFs.CONTEXTMENU_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case ConverterNeuroimaging2PDFs.TABLE_HEIGHT
					prop_format = ConverterNeuroimaging2PDFs.TABLE_HEIGHT_FORMAT;
				case ConverterNeuroimaging2PDFs.SELECTED
					prop_format = ConverterNeuroimaging2PDFs.SELECTED_FORMAT;
				case ConverterNeuroimaging2PDFs.TABLE
					prop_format = ConverterNeuroimaging2PDFs.TABLE_FORMAT;
				case ConverterNeuroimaging2PDFs.CONTEXTMENU
					prop_format = ConverterNeuroimaging2PDFs.CONTEXTMENU_FORMAT;
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				case ConverterNeuroimaging2PDFs.TABLE_HEIGHT
					prop_default = s(30);
				case ConverterNeuroimaging2PDFs.SELECTED
					prop_default = Format.getFormatDefault(Format.CVECTOR, ConverterNeuroimaging2PDFs.getPropSettings(prop));
				case ConverterNeuroimaging2PDFs.TABLE
					prop_default = Format.getFormatDefault(Format.HANDLE, ConverterNeuroimaging2PDFs.getPropSettings(prop));
				case ConverterNeuroimaging2PDFs.CONTEXTMENU
					prop_default = Format.getFormatDefault(Format.HANDLE, ConverterNeuroimaging2PDFs.getPropSettings(prop));
				case ConverterNeuroimaging2PDFs.ELCLASS
				...
				case ConverterNeuroimaging2PDFs.TEMPLATE
					prop_default = Format.getFormatDefault(Format.ITEM, ConverterNeuroimaging2PDFs.getPropSettings(prop));
				case ConverterNeuroimaging2PDFs.ID
					prop_default = 'SUVRConstructorPP_BR_DICT';
				case ConverterNeuroimaging2PDFs.LABEL
	...
	methods (Static, Access=protected) % conditioning
		function value = conditioning(pointer, value)
			...
			switch prop
				case ConverterNeuroimaging2PDFs.SELECTED % __ConverterNeuroimaging2PDFs.SELECTED__
					if isrow(value)
					    value = value';
					end
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			%  Error id: €BRAPH2.STR€:ConverterNeuroimaging2PDFs:€BRAPH2.WRONG_INPUT€
			% 
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			...
			switch prop
				case ConverterNeuroimaging2PDFs.TABLE_HEIGHT % __ConverterNeuroimaging2PDFs.TABLE_HEIGHT__
					check = Format.checkFormat(Format.SIZE, value, ConverterNeuroimaging2PDFs.getPropSettings(prop));
				case ConverterNeuroimaging2PDFs.SELECTED % __ConverterNeuroimaging2PDFs.SELECTED__
					check = Format.checkFormat(Format.CVECTOR, value, ConverterNeuroimaging2PDFs.getPropSettings(prop));
				case ConverterNeuroimaging2PDFs.TABLE % __ConverterNeuroimaging2PDFs.TABLE__
					check = Format.checkFormat(Format.HANDLE, value, ConverterNeuroimaging2PDFs.getPropSettings(prop));
				case ConverterNeuroimaging2PDFs.CONTEXTMENU % __ConverterNeuroimaging2PDFs.CONTEXTMENU__
					check = Format.checkFormat(Format.HANDLE, value, ConverterNeuroimaging2PDFs.getPropSettings(prop));
				case ConverterNeuroimaging2PDFs.TEMPLATE % __ConverterNeuroimaging2PDFs.TEMPLATE__
					check = Format.checkFormat(Format.ITEM, value, ConverterNeuroimaging2PDFs.getPropSettings(prop));
				otherwise
					if prop <= PanelProp.getPropNumber()
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case ConverterNeuroimaging2PDFs.X_DRAW % __ConverterNeuroimaging2PDFs.X_DRAW__
				...
				case ConverterNeuroimaging2PDFs.UPDATE % __ConverterNeuroimaging2PDFs.UPDATE__
				...
				case ConverterNeuroimaging2PDFs.REDRAW % __ConverterNeuroimaging2PDFs.REDRAW__
				...
				case ConverterNeuroimaging2PDFs.SHOW % __ConverterNeuroimaging2PDFs.SHOW__
					value = calculateValue@PanelProp(pr, PanelProp.SHOW, varargin{:}); % also warning
					
				case ConverterNeuroimaging2PDFs.HIDE % __ConverterNeuroimaging2PDFs.HIDE__
					value = calculateValue@PanelProp(pr, PanelProp.HIDE, varargin{:}); % also warning
					
				case ConverterNeuroimaging2PDFs.DELETE % __ConverterNeuroimaging2PDFs.DELETE__
				...
				case ConverterNeuroimaging2PDFs.CLOSE % __ConverterNeuroimaging2PDFs.CLOSE__
