	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case AnalyzeGroup_ST_MP_BUD.DENSITIES % __AnalyzeGroup_ST_MP_BUD.DENSITIES__
					prop_default = [1:1:10];
				case AnalyzeGroup_ST_MP_BUD.ELCLASS % __AnalyzeGroup_ST_MP_BUD.ELCLASS__
					prop_default = 'AnalyzeGroup_ST_MP_BUD';
				case AnalyzeGroup_ST_MP_BUD.NAME % __AnalyzeGroup_ST_MP_BUD.NAME__
					prop_default = 'Multiplex Structural Binary Undirected at fixed Densities Analyze Group';
				case AnalyzeGroup_ST_MP_BUD.DESCRIPTION % __AnalyzeGroup_ST_MP_BUD.DESCRIPTION__
				...
				case AnalyzeGroup_ST_MP_BUD.ID % __AnalyzeGroup_ST_MP_BUD.ID__
					prop_default = 'AnalyzeGroup_ST_MP_BUD ID';
				case AnalyzeGroup_ST_MP_BUD.LABEL % __AnalyzeGroup_ST_MP_BUD.LABEL__
					prop_default = 'AnalyzeGroup_ST_MP_BUD label';
				case AnalyzeGroup_ST_MP_BUD.NOTES % __AnalyzeGroup_ST_MP_BUD.NOTES__
					prop_default = 'AnalyzeGroup_ST_MP_BUD notes';
				case AnalyzeGroup_ST_MP_BUD.GR % __AnalyzeGroup_ST_MP_BUD.GR__
