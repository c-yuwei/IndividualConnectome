	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case SubjectST_MP.ELCLASS % __SubjectST_MP.ELCLASS__
					prop_default = 'SubjectST_MP';
				case SubjectST_MP.NAME % __SubjectST_MP.NAME__
					prop_default = 'Multiplex Structural Subject';
				case SubjectST_MP.DESCRIPTION % __SubjectST_MP.DESCRIPTION__
				...
				case SubjectST_MP.ID % __SubjectST_MP.ID__
					prop_default = 'SubjectST_MP ID';
				case SubjectST_MP.LABEL % __SubjectST_MP.LABEL__
					prop_default = 'SubjectST_MP label';
				case SubjectST_MP.NOTES % __SubjectST_MP.NOTES__
