	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case AnalyzeGroup_ST_MP_BUT.THRESHOLDS % __AnalyzeGroup_ST_MP_BUT.THRESHOLDS__
					prop_default = [-1:.5:1];
				case AnalyzeGroup_ST_MP_BUT.ELCLASS % __AnalyzeGroup_ST_MP_BUT.ELCLASS__
					prop_default = 'AnalyzeGroup_ST_MP_BUT';
				case AnalyzeGroup_ST_MP_BUT.NAME % __AnalyzeGroup_ST_MP_BUT.NAME__
					prop_default = 'Multiplex Structural Binary Undirected at fixed Thresholds Analyze Group';
				case AnalyzeGroup_ST_MP_BUT.DESCRIPTION % __AnalyzeGroup_ST_MP_BUT.DESCRIPTION__
				...
				case AnalyzeGroup_ST_MP_BUT.ID % __AnalyzeGroup_ST_MP_BUT.ID__
					prop_default = 'AnalyzeGroup_ST_MP_BUT ID';
				case AnalyzeGroup_ST_MP_BUT.LABEL % __AnalyzeGroup_ST_MP_BUT.LABEL__
					prop_default = 'AnalyzeGroup_ST_MP_BUT label';
				case AnalyzeGroup_ST_MP_BUT.NOTES % __AnalyzeGroup_ST_MP_BUT.NOTES__
					prop_default = 'AnalyzeGroup_ST_MP_BUT notes';
				case AnalyzeGroup_ST_MP_BUT.GR % __AnalyzeGroup_ST_MP_BUT.GR__
