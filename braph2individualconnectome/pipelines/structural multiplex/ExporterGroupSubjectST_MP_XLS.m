	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case ExporterGroupSubjectST_MP_XLS.ELCLASS % __ExporterGroupSubjectST_MP_XLS.ELCLASS__
					prop_default = 'ExporterGroupSubjectST_MP_XLS';
				case ExporterGroupSubjectST_MP_XLS.NAME % __ExporterGroupSubjectST_MP_XLS.NAME__
					prop_default = 'Multiplex Structural Subject Group XLS Exporter';
				case ExporterGroupSubjectST_MP_XLS.DESCRIPTION % __ExporterGroupSubjectST_MP_XLS.DESCRIPTION__
				...
				case ExporterGroupSubjectST_MP_XLS.TEMPLATE % __ExporterGroupSubjectST_MP_XLS.TEMPLATE__
					prop_default = Format.getFormatDefault(8, ExporterGroupSubjectST_MP_XLS.getPropSettings(prop));
				case ExporterGroupSubjectST_MP_XLS.ID % __ExporterGroupSubjectST_MP_XLS.ID__
					prop_default = 'ExporterGroupSubjectST_MP_XLS ID';
				case ExporterGroupSubjectST_MP_XLS.LABEL % __ExporterGroupSubjectST_MP_XLS.LABEL__
					prop_default = 'ExporterGroupSubjectST_MP_XLS label';
				case ExporterGroupSubjectST_MP_XLS.NOTES % __ExporterGroupSubjectST_MP_XLS.NOTES__
