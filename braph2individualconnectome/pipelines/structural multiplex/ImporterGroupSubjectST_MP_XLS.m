	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case ImporterGroupSubjectST_MP_XLS.ELCLASS % __ImporterGroupSubjectST_MP_XLS.ELCLASS__
					prop_default = 'ImporterGroupSubjectST_MP_XLS';
				case ImporterGroupSubjectST_MP_XLS.NAME % __ImporterGroupSubjectST_MP_XLS.NAME__
					prop_default = 'Multiplex Structural Subject Group XLS Importer';
				case ImporterGroupSubjectST_MP_XLS.DESCRIPTION % __ImporterGroupSubjectST_MP_XLS.DESCRIPTION__
				...
				case ImporterGroupSubjectST_MP_XLS.TEMPLATE % __ImporterGroupSubjectST_MP_XLS.TEMPLATE__
					prop_default = Format.getFormatDefault(8, ImporterGroupSubjectST_MP_XLS.getPropSettings(prop));
				case ImporterGroupSubjectST_MP_XLS.ID % __ImporterGroupSubjectST_MP_XLS.ID__
					prop_default = 'ImporterGroupSubjectST_MP_XLS ID';
				case ImporterGroupSubjectST_MP_XLS.LABEL % __ImporterGroupSubjectST_MP_XLS.LABEL__
					prop_default = 'ImporterGroupSubjectST_MP_XLS label';
				case ImporterGroupSubjectST_MP_XLS.NOTES % __ImporterGroupSubjectST_MP_XLS.NOTES__
