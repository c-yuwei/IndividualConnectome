	...
	methods (Static) % inspection
			...
			if nargin == 0
				prop_list = [ ...
					NNDataPoint.getProps() ...
						...
						NNDataPoint_FUN_CLA.TARGET_CLASS ...
						];
				return
			end
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case NNDataPoint_FUN_CLA.TARGET_CLASS
						tag = NNDataPoint_FUN_CLA.TARGET_CLASS_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case NNDataPoint_FUN_CLA.TARGET_CLASS
					prop_category = NNDataPoint_FUN_CLA.TARGET_CLASS_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case NNDataPoint_FUN_CLA.TARGET_CLASS
					prop_format = NNDataPoint_FUN_CLA.TARGET_CLASS_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case NNDataPoint_FUN_CLA.TARGET_CLASS
					prop_description = 'TARGET_CLASS (parameter, stringlist) is a list of variable-of-interest IDs to be used as classification targets.';
				case NNDataPoint_FUN_CLA.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the data point for classification with functional data.';
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				...
				case NNDataPoint_FUN_CLA.TARGET_CLASS % __NNDataPoint_FUN_CLA.TARGET_CLASS__
