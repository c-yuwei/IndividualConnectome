classdef AnalyzeEnsemble_CON_WU < AnalyzeEnsemble
	...
	methods (Static) % inspection
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case AnalyzeEnsemble_CON_WU.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the ensemble-based graph analysis using connectivity data.';
				case AnalyzeEnsemble_CON_WU.NAME
					prop_description = 'NAME (constant, string) is the name of the ensemble-based graph analysis using connectivity data.';
				case AnalyzeEnsemble_CON_WU.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the ensemble-based graph analysis using connectivity data.';
				case AnalyzeEnsemble_CON_WU.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the ensemble-based graph analysis using connectivity data.';
				case AnalyzeEnsemble_CON_WU.ID
					prop_description = 'ID (data, string) is a few-letter code for the ensemble-based graph analysis using connectivity data.';
				case AnalyzeEnsemble_CON_WU.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the ensemble-based graph analysis using connectivity data.';
				case AnalyzeEnsemble_CON_WU.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the ensemble-based graph analysis using connectivity data.';
