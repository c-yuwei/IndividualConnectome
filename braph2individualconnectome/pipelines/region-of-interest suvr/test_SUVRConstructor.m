...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	roic_1 = SUVRConstructor( ...
		...
		SUVRConstructor.ATLAS_KIND, roic_0.getCallback(10), ..., ...
		SUVRConstructor.BA, roic_0.getCallback(11), ..., ...
		SUVRConstructor.ATLAS_INDEX, roic_0.getCallback(12), ..., ...
		SUVRConstructor.ATLAS_PATH_DICT, roic_0.getCallback(13), ..., ...
		SUVRConstructor.GR_PET, roic_0.getCallback(14), ..., ...
		SUVRConstructor.GR_T1, roic_0.getCallback(15), ..., ...
		SUVRConstructor.SUVR_REGION_SELECTION, roic_0.getCallback(16), ..., ...
		SUVRConstructor.CALC_SUBJ_SUVR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.GR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.WAITBAR, roic_0.getCallback(19) ... ...
		);
	...
	roic_2 = SUVRConstructor( ...
		...
		SUVRConstructor.ATLAS_KIND, roic_1.getCallback(10), ..., ...
		SUVRConstructor.BA, roic_1.getCallback(11), ..., ...
		SUVRConstructor.ATLAS_INDEX, roic_1.getCallback(12), ..., ...
		SUVRConstructor.ATLAS_PATH_DICT, roic_1.getCallback(13), ..., ...
		SUVRConstructor.GR_PET, roic_1.getCallback(14), ..., ...
		SUVRConstructor.GR_T1, roic_1.getCallback(15), ..., ...
		SUVRConstructor.SUVR_REGION_SELECTION, roic_1.getCallback(16), ..., ...
		SUVRConstructor.CALC_SUBJ_SUVR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.GR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.WAITBAR, roic_1.getCallback(19) ... ...
		);
	...
	roic_3 = SUVRConstructor( ...
		...
		SUVRConstructor.ATLAS_KIND, roic_2.getCallback(10), ..., ...
		SUVRConstructor.BA, roic_2.getCallback(11), ..., ...
		SUVRConstructor.ATLAS_INDEX, roic_2.getCallback(12), ..., ...
		SUVRConstructor.ATLAS_PATH_DICT, roic_2.getCallback(13), ..., ...
		SUVRConstructor.GR_PET, roic_2.getCallback(14), ..., ...
		SUVRConstructor.GR_T1, roic_2.getCallback(15), ..., ...
		SUVRConstructor.SUVR_REGION_SELECTION, roic_2.getCallback(16), ..., ...
		SUVRConstructor.CALC_SUBJ_SUVR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.GR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.WAITBAR, roic_2.getCallback(19) ... ...
		);
