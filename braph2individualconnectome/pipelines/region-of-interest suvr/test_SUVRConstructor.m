...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	roic_1 = SUVRConstructor( ...
		...
		SUVRConstructor.ATLAS_INDEX, roic_0.getCallback(15), ..., ...
		SUVRConstructor.ATLAS_PATH_DICT, roic_0.getCallback(16), ..., ...
		SUVRConstructor.GR_PET, roic_0.getCallback(17), ..., ...
		SUVRConstructor.GR_T1, roic_0.getCallback(18), ..., ...
		SUVRConstructor.SUVR_REGION_SELECTION, roic_0.getCallback(19), ..., ...
		SUVRConstructor.CALC_SUBJ_SUVR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.GR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.WAITBAR, roic_0.getCallback(22) ... ...
		);
	...
	roic_2 = SUVRConstructor( ...
		...
		SUVRConstructor.ATLAS_INDEX, roic_1.getCallback(15), ..., ...
		SUVRConstructor.ATLAS_PATH_DICT, roic_1.getCallback(16), ..., ...
		SUVRConstructor.GR_PET, roic_1.getCallback(17), ..., ...
		SUVRConstructor.GR_T1, roic_1.getCallback(18), ..., ...
		SUVRConstructor.SUVR_REGION_SELECTION, roic_1.getCallback(19), ..., ...
		SUVRConstructor.CALC_SUBJ_SUVR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.GR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.WAITBAR, roic_1.getCallback(22) ... ...
		);
	...
	roic_3 = SUVRConstructor( ...
		...
		SUVRConstructor.ATLAS_INDEX, roic_2.getCallback(15), ..., ...
		SUVRConstructor.ATLAS_PATH_DICT, roic_2.getCallback(16), ..., ...
		SUVRConstructor.GR_PET, roic_2.getCallback(17), ..., ...
		SUVRConstructor.GR_T1, roic_2.getCallback(18), ..., ...
		SUVRConstructor.SUVR_REGION_SELECTION, roic_2.getCallback(19), ..., ...
		SUVRConstructor.CALC_SUBJ_SUVR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.GR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.WAITBAR, roic_2.getCallback(22) ... ...
		);
