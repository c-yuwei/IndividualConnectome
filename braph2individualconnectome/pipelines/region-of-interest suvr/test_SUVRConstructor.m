...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	roic = SUVRConstructor( ...
		...
		SUVRConstructor.ATLAS_REGION_IDS, SUVRConstructor.getPropDefault(SUVRConstructor.ATLAS_REGION_IDS), ...
		SUVRConstructor.ATLAS_LABELS, SUVRConstructor.getPropDefault(SUVRConstructor.ATLAS_LABELS), ...
		SUVRConstructor.MAPPING_PATH_DICT, SUVRConstructor.getPropDefault(SUVRConstructor.MAPPING_PATH_DICT), ...
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	roic_1 = SUVRConstructor( ...
		...
		SUVRConstructor.NOTES, SUVRConstructor.getPropDefault(SUVRConstructor.NOTES), ...
		SUVRConstructor.TOSTRING, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.BA, roic_0.getCallback(9), ..., ...
		SUVRConstructor.ATLAS_REGION_IDS, roic_0.getCallback(10), ..., ...
		SUVRConstructor.ATLAS_LABELS, roic_0.getCallback(11), ..., ...
		SUVRConstructor.MAPPING_PATH_DICT, roic_0.getCallback(12), ..., ...
		SUVRConstructor.REF_REGION_LIST, roic_0.getCallback(13), ..., ...
		SUVRConstructor.REF_BR_DICT, roic_0.getCallback(14), ..., ...
		SUVRConstructor.ATLAS_KIND, roic_0.getCallback(15), ..., ...
		SUVRConstructor.ATLAS_INDEX, roic_0.getCallback(16), ..., ...
		SUVRConstructor.ATLAS_PATH_DICT, roic_0.getCallback(17), ..., ...
		SUVRConstructor.GR_PET, roic_0.getCallback(18), ..., ...
		SUVRConstructor.GR_T1, roic_0.getCallback(19), ..., ...
		SUVRConstructor.SUVR_REGION_SELECTION, roic_0.getCallback(20), ..., ...
		SUVRConstructor.CALC_SUBJ_SUVR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.GR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.WAITBAR, roic_0.getCallback(23) ... ...
		);
	...
	roic_2 = SUVRConstructor( ...
		...
		SUVRConstructor.NOTES, SUVRConstructor.getPropDefault(SUVRConstructor.NOTES), ...
		SUVRConstructor.TOSTRING, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.BA, roic_1.getCallback(9), ..., ...
		SUVRConstructor.ATLAS_REGION_IDS, roic_1.getCallback(10), ..., ...
		SUVRConstructor.ATLAS_LABELS, roic_1.getCallback(11), ..., ...
		SUVRConstructor.MAPPING_PATH_DICT, roic_1.getCallback(12), ..., ...
		SUVRConstructor.REF_REGION_LIST, roic_1.getCallback(13), ..., ...
		SUVRConstructor.REF_BR_DICT, roic_1.getCallback(14), ..., ...
		SUVRConstructor.ATLAS_KIND, roic_1.getCallback(15), ..., ...
		SUVRConstructor.ATLAS_INDEX, roic_1.getCallback(16), ..., ...
		SUVRConstructor.ATLAS_PATH_DICT, roic_1.getCallback(17), ..., ...
		SUVRConstructor.GR_PET, roic_1.getCallback(18), ..., ...
		SUVRConstructor.GR_T1, roic_1.getCallback(19), ..., ...
		SUVRConstructor.SUVR_REGION_SELECTION, roic_1.getCallback(20), ..., ...
		SUVRConstructor.CALC_SUBJ_SUVR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.GR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.WAITBAR, roic_1.getCallback(23) ... ...
		);
	...
	roic_3 = SUVRConstructor( ...
		...
		SUVRConstructor.NOTES, SUVRConstructor.getPropDefault(SUVRConstructor.NOTES), ...
		SUVRConstructor.TOSTRING, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.BA, roic_2.getCallback(9), ..., ...
		SUVRConstructor.ATLAS_REGION_IDS, roic_2.getCallback(10), ..., ...
		SUVRConstructor.ATLAS_LABELS, roic_2.getCallback(11), ..., ...
		SUVRConstructor.MAPPING_PATH_DICT, roic_2.getCallback(12), ..., ...
		SUVRConstructor.REF_REGION_LIST, roic_2.getCallback(13), ..., ...
		SUVRConstructor.REF_BR_DICT, roic_2.getCallback(14), ..., ...
		SUVRConstructor.ATLAS_KIND, roic_2.getCallback(15), ..., ...
		SUVRConstructor.ATLAS_INDEX, roic_2.getCallback(16), ..., ...
		SUVRConstructor.ATLAS_PATH_DICT, roic_2.getCallback(17), ..., ...
		SUVRConstructor.GR_PET, roic_2.getCallback(18), ..., ...
		SUVRConstructor.GR_T1, roic_2.getCallback(19), ..., ...
		SUVRConstructor.SUVR_REGION_SELECTION, roic_2.getCallback(20), ..., ...
		SUVRConstructor.CALC_SUBJ_SUVR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.GR, SUVRConstructor.getNoValue(), ...
		SUVRConstructor.WAITBAR, roic_2.getCallback(23) ... ...
		);
