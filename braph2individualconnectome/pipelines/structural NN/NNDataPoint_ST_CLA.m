	...
	methods (Static) % inspection
			...
			if nargin == 0
				prop_list = [ ...
					NNDataPoint.getProps() ...
						...
						NNDataPoint_ST_CLA.TARGET_CLASS ...
						];
				return
			end
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case NNDataPoint_ST_CLA.TARGET_CLASS
						tag = NNDataPoint_ST_CLA.TARGET_CLASS_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case NNDataPoint_ST_CLA.TARGET_CLASS
					prop_category = NNDataPoint_ST_CLA.TARGET_CLASS_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case NNDataPoint_ST_CLA.TARGET_CLASS
					prop_format = NNDataPoint_ST_CLA.TARGET_CLASS_FORMAT;
				otherwise
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				...
				case NNDataPoint_ST_CLA.TARGET_CLASS % __NNDataPoint_ST_CLA.TARGET_CLASS__
