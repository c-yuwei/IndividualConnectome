...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	pdfc = PDFConstructor( ...
		...
		PDFConstructor.ATLAS_REGION_IDS, PDFConstructor.getPropDefault(PDFConstructor.ATLAS_REGION_IDS), ...
		PDFConstructor.ATLAS_LABELS, PDFConstructor.getPropDefault(PDFConstructor.ATLAS_LABELS), ...
		PDFConstructor.MAPPING_PATH_DICT, PDFConstructor.getPropDefault(PDFConstructor.MAPPING_PATH_DICT), ...
		PDFConstructor.REF_REGION_LIST, PDFConstructor.getPropDefault(PDFConstructor.REF_REGION_LIST), ...
		PDFConstructor.REF_BR_DICT, PDFConstructor.getPropDefault(PDFConstructor.REF_BR_DICT), ...
		...
		PDFConstructor.PDF_REGION_SELECTION, PDFConstructor.getPropDefault(PDFConstructor.PDF_REGION_SELECTION), ...
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	pdfc_1 = PDFConstructor( ...
		...
		PDFConstructor.NOTES, PDFConstructor.getPropDefault(PDFConstructor.NOTES), ...
		PDFConstructor.TOSTRING, PDFConstructor.getNoValue(), ...
		PDFConstructor.BA, pdfc_0.getCallback(9), ..., ...
		PDFConstructor.ATLAS_REGION_IDS, pdfc_0.getCallback(10), ..., ...
		PDFConstructor.ATLAS_LABELS, pdfc_0.getCallback(11), ..., ...
		PDFConstructor.MAPPING_PATH_DICT, pdfc_0.getCallback(12), ..., ...
		PDFConstructor.REF_REGION_LIST, pdfc_0.getCallback(13), ..., ...
		PDFConstructor.REF_BR_DICT, pdfc_0.getCallback(14), ..., ...
		PDFConstructor.ATLAS_INDEX, pdfc_0.getCallback(15), ..., ...
		PDFConstructor.ATLAS_PATH_DICT, pdfc_0.getCallback(16), ..., ...
		PDFConstructor.GR_PET, pdfc_0.getCallback(17), ..., ...
		PDFConstructor.GR_T1, pdfc_0.getCallback(18), ..., ...
		PDFConstructor.PDF_REGION_SELECTION, pdfc_0.getCallback(19), ..., ...
		PDFConstructor.CALC_SUBJ_PDF, PDFConstructor.getNoValue(), ...
		PDFConstructor.GR, PDFConstructor.getNoValue(), ...
		PDFConstructor.WAITBAR, pdfc_0.getCallback(22) ... ...
		);
	...
	pdfc_2 = PDFConstructor( ...
		...
		PDFConstructor.NOTES, PDFConstructor.getPropDefault(PDFConstructor.NOTES), ...
		PDFConstructor.TOSTRING, PDFConstructor.getNoValue(), ...
		PDFConstructor.BA, pdfc_1.getCallback(9), ..., ...
		PDFConstructor.ATLAS_REGION_IDS, pdfc_1.getCallback(10), ..., ...
		PDFConstructor.ATLAS_LABELS, pdfc_1.getCallback(11), ..., ...
		PDFConstructor.MAPPING_PATH_DICT, pdfc_1.getCallback(12), ..., ...
		PDFConstructor.REF_REGION_LIST, pdfc_1.getCallback(13), ..., ...
		PDFConstructor.REF_BR_DICT, pdfc_1.getCallback(14), ..., ...
		PDFConstructor.ATLAS_INDEX, pdfc_1.getCallback(15), ..., ...
		PDFConstructor.ATLAS_PATH_DICT, pdfc_1.getCallback(16), ..., ...
		PDFConstructor.GR_PET, pdfc_1.getCallback(17), ..., ...
		PDFConstructor.GR_T1, pdfc_1.getCallback(18), ..., ...
		PDFConstructor.PDF_REGION_SELECTION, pdfc_1.getCallback(19), ..., ...
		PDFConstructor.CALC_SUBJ_PDF, PDFConstructor.getNoValue(), ...
		PDFConstructor.GR, PDFConstructor.getNoValue(), ...
		PDFConstructor.WAITBAR, pdfc_1.getCallback(22) ... ...
		);
	...
	pdfc_3 = PDFConstructor( ...
		...
		PDFConstructor.NOTES, PDFConstructor.getPropDefault(PDFConstructor.NOTES), ...
		PDFConstructor.TOSTRING, PDFConstructor.getNoValue(), ...
		PDFConstructor.BA, pdfc_2.getCallback(9), ..., ...
		PDFConstructor.ATLAS_REGION_IDS, pdfc_2.getCallback(10), ..., ...
		PDFConstructor.ATLAS_LABELS, pdfc_2.getCallback(11), ..., ...
		PDFConstructor.MAPPING_PATH_DICT, pdfc_2.getCallback(12), ..., ...
		PDFConstructor.REF_REGION_LIST, pdfc_2.getCallback(13), ..., ...
		PDFConstructor.REF_BR_DICT, pdfc_2.getCallback(14), ..., ...
		PDFConstructor.ATLAS_INDEX, pdfc_2.getCallback(15), ..., ...
		PDFConstructor.ATLAS_PATH_DICT, pdfc_2.getCallback(16), ..., ...
		PDFConstructor.GR_PET, pdfc_2.getCallback(17), ..., ...
		PDFConstructor.GR_T1, pdfc_2.getCallback(18), ..., ...
		PDFConstructor.PDF_REGION_SELECTION, pdfc_2.getCallback(19), ..., ...
		PDFConstructor.CALC_SUBJ_PDF, PDFConstructor.getNoValue(), ...
		PDFConstructor.GR, PDFConstructor.getNoValue(), ...
		PDFConstructor.WAITBAR, pdfc_2.getCallback(22) ... ...
		);
