...
for i = 1:length(sub_list_CN)
    ...
    if isequal(CON_CN_id,suvr_CN_id{i})
        baseline_matrix = repmat(suvr_vector', size(connectome_matrix,2),1);%suvr_vector * suvr_vector'; % Outer product for baseline layer
        sub = SubjectCON_MP( ...
            ...
            'LAYERLABELS', {'Baseline','Connectome'}, ...
            'CON_MP', {baseline_matrix,connectome_matrix});
...
save('Results/classification_DistanceSUVRDoubleLayer_Balanced(CN pos)NEW_ref_distance','results')
