classdef AnalyzeEnsembleDivergence_FUN_WU < AnalyzeEnsemble
	...
	properties (Constant) % properties
		CONNECTOME_CONSTRUCT_METHOD = AnalyzeEnsemble.getPropNumber() + 1;
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = subclasses('AnalyzeEnsembleDivergence_FUN_WU', [], [], true);
		end
			...
			if nargin == 0
				prop_list = [ ...
					AnalyzeEnsemble.getProps() ...
						AnalyzeEnsembleDivergence_FUN_WU.CONNECTOME_CONSTRUCT_METHOD ...
						];
				return
			end
		...
		function prop_number = getPropNumber(varargin)
			...
			prop_number = numel(AnalyzeEnsembleDivergence_FUN_WU.getProps(varargin{:}));
		end
		function check_out = existsProp(prop)
			...
			check = any(prop == AnalyzeEnsembleDivergence_FUN_WU.getProps());
			
			if nargout == 1
				check_out = check;
			elseif ~check
				error( ...
					[BRAPH2.STR ':AnalyzeEnsembleDivergence_FUN_WU:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':AnalyzeEnsembleDivergence_FUN_WU:' BRAPH2.WRONG_INPUT '\n' ...
		...
		function check_out = existsTag(tag)
			...
			analyzeensembledivergence_fun_wu_tag_list = cellfun(@(x) AnalyzeEnsembleDivergence_FUN_WU.getPropTag(x), num2cell(AnalyzeEnsembleDivergence_FUN_WU.getProps()), 'UniformOutput', false);
			check = any(strcmp(tag, analyzeensembledivergence_fun_wu_tag_list));
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				analyzeensembledivergence_fun_wu_tag_list = cellfun(@(x) AnalyzeEnsembleDivergence_FUN_WU.getPropTag(x), num2cell(AnalyzeEnsembleDivergence_FUN_WU.getProps()), 'UniformOutput', false);
				prop = find(strcmp(pointer, analyzeensembledivergence_fun_wu_tag_list)); % tag = pointer
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case AnalyzeEnsembleDivergence_FUN_WU.CONNECTOME_CONSTRUCT_METHOD
						tag = AnalyzeEnsembleDivergence_FUN_WU.CONNECTOME_CONSTRUCT_METHOD_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case AnalyzeEnsembleDivergence_FUN_WU.CONNECTOME_CONSTRUCT_METHOD
					prop_category = AnalyzeEnsembleDivergence_FUN_WU.CONNECTOME_CONSTRUCT_METHOD_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case AnalyzeEnsembleDivergence_FUN_WU.CONNECTOME_CONSTRUCT_METHOD
					prop_format = AnalyzeEnsembleDivergence_FUN_WU.CONNECTOME_CONSTRUCT_METHOD_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case AnalyzeEnsembleDivergence_FUN_WU.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the ensemble-based graph analysis with functional data.';
				case AnalyzeEnsembleDivergence_FUN_WU.NAME
					prop_description = 'NAME (constant, string) is the name of the ensemble-based graph analysis with functional data.';
				case AnalyzeEnsembleDivergence_FUN_WU.DESCRIPTION
				...
				case AnalyzeEnsembleDivergence_FUN_WU.GR
					prop_description = 'GR (data, item) is the subject group, which also defines the subject class SubjectFUN.';
				case AnalyzeEnsembleDivergence_FUN_WU.GRAPH_TEMPLATE
					prop_description = 'GRAPH_TEMPLATE (parameter, item) is the graph template to set all graph and measure parameters.';
				case AnalyzeEnsembleDivergence_FUN_WU.G_DICT
					prop_description = 'G_DICT (result, idict) is the graph (GraphWU) ensemble of Jensen–Shannon divergence individual connectivity matrix.';
				case AnalyzeEnsembleDivergence_FUN_WU.ME_DICT
					prop_description = 'ME_DICT (result, idict) contains the calculated measures of the graph ensemble.';
				case AnalyzeEnsembleDivergence_FUN_WU.WAITBAR
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				case AnalyzeEnsembleDivergence_FUN_WU.CONNECTOME_CONSTRUCT_METHOD
					prop_default = Format.getFormatDefault(Format.CELL, AnalyzeEnsembleDivergence_FUN_WU.getPropSettings(prop));
				case AnalyzeEnsembleDivergence_FUN_WU.ELCLASS
				...
				case AnalyzeEnsembleDivergence_FUN_WU.GRAPH_TEMPLATE
					prop_default = Format.getFormatDefault(Format.ITEM, AnalyzeEnsembleDivergence_FUN_WU.getPropSettings(prop));
				case AnalyzeEnsembleDivergence_FUN_WU.G_DICT
					prop_default = Format.getFormatDefault(Format.IDICT, AnalyzeEnsembleDivergence_FUN_WU.getPropSettings(prop));
				case AnalyzeEnsembleDivergence_FUN_WU.WAITBAR
					prop_default = true;
				otherwise
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			%  Error id: €BRAPH2.STR€:AnalyzeEnsembleDivergence_FUN_WU:€BRAPH2.WRONG_INPUT€
			% 
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			...
			switch prop
				case AnalyzeEnsembleDivergence_FUN_WU.CONNECTOME_CONSTRUCT_METHOD % __AnalyzeEnsembleDivergence_FUN_WU.CONNECTOME_CONSTRUCT_METHOD__
					check = Format.checkFormat(Format.CELL, value, AnalyzeEnsembleDivergence_FUN_WU.getPropSettings(prop));
				case AnalyzeEnsembleDivergence_FUN_WU.GRAPH_TEMPLATE % __AnalyzeEnsembleDivergence_FUN_WU.GRAPH_TEMPLATE__
					check = Format.checkFormat(Format.ITEM, value, AnalyzeEnsembleDivergence_FUN_WU.getPropSettings(prop));
				case AnalyzeEnsembleDivergence_FUN_WU.G_DICT % __AnalyzeEnsembleDivergence_FUN_WU.G_DICT__
					check = Format.checkFormat(Format.IDICT, value, AnalyzeEnsembleDivergence_FUN_WU.getPropSettings(prop));
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(a, prop, varargin)
			...
			switch prop
				...
				case AnalyzeEnsembleDivergence_FUN_WU.G_DICT % __AnalyzeEnsembleDivergence_FUN_WU.G_DICT__
					rng_settings_ = rng(); rng(a.getPropSeed(AnalyzeEnsembleDivergence_FUN_WU.G_DICT), 'twister')
