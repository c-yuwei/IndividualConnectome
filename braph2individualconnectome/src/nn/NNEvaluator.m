classdef NNEvaluator < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'NNEvaluator'  'NNClassifierMLP_Evaluator'  'NNRegressorMLP_Evaluator'  'NNClassifierMLP_Evaluator_VOIs'  'NNRegressorMLP_Evaluator_VOIs' }; %CET: Computational Efficiency Trick
		end
