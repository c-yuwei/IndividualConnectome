classdef NNDataPoint < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'NNDataPoint'  'NNDataPointMLP_Shuffled'  'NNDataPoint_Graph_CLA'  'NNDataPoint_Graph_REG'  'NNDataPoint_Measure_CLA'  'NNDataPoint_Measure_REG'  'NNDataPoint_CON_CLA'  'NNDataPoint_CON_REG'  'NNDataPoint_FUN_CLA'  'NNDataPoint_FUN_REG'  'NNDataPoint_ST_CLA'  'NNDataPoint_ST_REG'  'NNDataPoint_VOIs' }; %CET: Computational Efficiency Trick
		end
