classdef NNCrossValidation < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'NNCrossValidation'  'NNClassifierMLP_CrossValidation'  'NNRegressorMLP_CrossValidation'  'NNClassifierMLP_CrossValidation_VOIs' }; %CET: Computational Efficiency Trick
		end
