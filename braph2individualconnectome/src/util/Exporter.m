classdef Exporter < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'Exporter'  'ExporterGroupSubjectCON_TXT'  'ExporterGroupSubjectCON_XLS'  'ExporterGroupSubjectFUN_TXT'  'ExporterGroupSubjectFUN_XLS'  'ExporterGroupSubjectST_TXT'  'ExporterGroupSubjectST_XLS'  'ExporterBrainAtlasTXT'  'ExporterBrainAtlasXLS'  'ExporterPipelineBRAPH2' }; %CET: Computational Efficiency Trick
		end
