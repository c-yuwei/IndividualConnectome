classdef Importer < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'Importer'  'ImporterGroupSubjectCON_TXT'  'ImporterGroupSubjectCON_XLS'  'ImporterGroupSubjectCON_MP_TXT'  'ImporterGroupSubjectCON_MP_XLS'  'ImporterGroupSubjectFUN_TXT'  'ImporterGroupSubjectFUN_XLS'  'ImporterGroupSubjectNeuroimaging_NIfTI'  'ImporterGroupSubjectST_TXT'  'ImporterGroupSubjectST_XLS'  'ImporterGroupSubjectST_MP_XLS'  'ImporterBrainAtlasTXT'  'ImporterBrainAtlasXLS'  'ImporterBrainSurfaceNV'  'ImporterPipelineBRAPH2' }; %CET: Computational Efficiency Trick
		end
