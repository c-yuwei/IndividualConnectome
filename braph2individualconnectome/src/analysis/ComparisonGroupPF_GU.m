classdef ComparisonGroupPF_GU < ComparisonGroupPF
	...
	properties (Constant) % properties
		LAYER = ComparisonGroupPF.getPropNumber() + 1;
		LAYER_TAG = 'LAYER';
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case ComparisonGroupPF_GU.LAYER
						tag = ComparisonGroupPF_GU.LAYER_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case ComparisonGroupPF_GU.LAYER
					prop_category = ComparisonGroupPF_GU.LAYER_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case ComparisonGroupPF_GU.LAYER
					prop_format = ComparisonGroupPF_GU.LAYER_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case ComparisonGroupPF_GU.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the ComparisonGroupPF_GU.';
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case ComparisonGroupPF_GU.LAYER % __ComparisonGroupPF_GU.LAYER__
					check = Format.checkFormat(Format.SCALAR, value, ComparisonGroupPF_GU.getPropSettings(prop));
