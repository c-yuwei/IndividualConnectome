classdef AnalyzeEnsemble < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'AnalyzeEnsemble'  'AnalyzeEnsemble_CON_BUD'  'AnalyzeEnsemble_CON_BUT'  'AnalyzeEnsemble_CON_WU'  'AnalyzeEnsemble_CON_MP_WU'  'AnalyzeEnsembleDivergence_FUN_WU'  'AnalyzeEnsemble_FUN_BUD'  'AnalyzeEnsemble_FUN_BUT'  'AnalyzeEnsemble_FUN_WU' }; %CET: Computational Efficiency Trick
		end
