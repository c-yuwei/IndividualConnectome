	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case ComparisonGroupPF_NU.LAYER
						tag = ComparisonGroupPF_NU.LAYER_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case ComparisonGroupPF_NU.LAYER
					prop_category = ComparisonGroupPF_NU.LAYER_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case ComparisonGroupPF_NU.LAYER
					prop_format = ComparisonGroupPF_NU.LAYER_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case ComparisonGroupPF_NU.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the ComparisonGroupPF_NU.';
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				...
				case ComparisonGroupPF_NU.LAYER % __ComparisonGroupPF_NU.LAYER__
					check = Format.checkFormat(Format.SCALAR, value, ComparisonGroupPF_NU.getPropSettings(prop));
