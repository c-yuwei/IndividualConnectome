classdef MeasureGroupBrainPF_NU < MeasureGroupBrainPF
	...
	properties (Constant) % properties
		MODULE = MeasureGroupBrainPF.getPropNumber() + 1;
		MODULE_TAG = 'MODULE';
		MODULE_CATEGORY = Category.FIGURE;
		MODULE_FORMAT = Format.SCALAR;
		
		LAYER = MeasureGroupBrainPF.getPropNumber() + 2;
		LAYER_TAG = 'LAYER';
		LAYER_CATEGORY = Category.FIGURE;
		LAYER_FORMAT = Format.SCALAR;
		
		SIZE_DIFF = MeasureGroupBrainPF.getPropNumber() + 3;
		SIZE_DIFF_TAG = 'SIZE_DIFF';
		SIZE_DIFF_CATEGORY = Category.FIGURE;
		SIZE_DIFF_FORMAT = Format.OPTION;
		
		SIZE_SCALE = MeasureGroupBrainPF.getPropNumber() + 4;
		SIZE_SCALE_TAG = 'SIZE_SCALE';
		SIZE_SCALE_CATEGORY = Category.FIGURE;
		SIZE_SCALE_FORMAT = Format.SCALAR;
		
		COLOR_DIFF = MeasureGroupBrainPF.getPropNumber() + 5;
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case MeasureGroupBrainPF_NU.MODULE
						tag = MeasureGroupBrainPF_NU.MODULE_TAG;
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case MeasureGroupBrainPF_NU.MODULE
					prop_category = MeasureGroupBrainPF_NU.MODULE_CATEGORY;
				case MeasureGroupBrainPF_NU.LAYER
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case MeasureGroupBrainPF_NU.MODULE
					prop_format = MeasureGroupBrainPF_NU.MODULE_FORMAT;
				case MeasureGroupBrainPF_NU.LAYER
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case MeasureGroupBrainPF_NU.MODULE
					prop_description = 'MODULE (figure, scalar) is the module selection for community structure.';
				case MeasureGroupBrainPF_NU.LAYER
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case MeasureGroupBrainPF_NU.MODULE % __MeasureGroupBrainPF_NU.MODULE__
