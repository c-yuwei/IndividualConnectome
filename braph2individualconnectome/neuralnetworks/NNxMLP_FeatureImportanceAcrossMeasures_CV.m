	...
	methods (Static) % inspection
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case NNxMLP_FeatureImportanceAcrossMeasures_CV.FI_TEMPLATE
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				...
				case NNxMLP_FeatureImportanceAcrossMeasures_CV.FI_TEMPLATE % __NNxMLP_FeatureImportanceAcrossMeasures_CV.FI_TEMPLATE__
					check = Format.checkFormat(Format.ITEM, value, NNxMLP_FeatureImportanceAcrossMeasures_CV.getPropSettings(prop));
				otherwise
