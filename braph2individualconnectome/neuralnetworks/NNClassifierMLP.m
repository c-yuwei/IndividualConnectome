classdef NNClassifierMLP < NNBase
	...
	properties (Constant) % properties
		TARGET_CLASSES = NNBase.getPropNumber() + 1;
		TARGET_CLASSES_TAG = 'TARGET_CLASSES';
		TARGET_CLASSES_CATEGORY = Category.QUERY;
		TARGET_CLASSES_FORMAT = Format.STRINGLIST;
	...
	methods (Static) % inspection
		...
		function prop_list = getProps(category)
			...
			if nargin == 0
				prop_list = [ ...
					NNBase.getProps() ...
						NNClassifierMLP.TARGET_CLASSES ...
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case NNClassifierMLP.TARGET_CLASSES
						tag = NNClassifierMLP.TARGET_CLASSES_TAG;
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case NNClassifierMLP.TARGET_CLASSES
					prop_category = NNClassifierMLP.TARGET_CLASSES_CATEGORY;
				case NNClassifierMLP.LAYERS
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case NNClassifierMLP.TARGET_CLASSES
					prop_format = NNClassifierMLP.TARGET_CLASSES_FORMAT;
				case NNClassifierMLP.LAYERS
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case NNClassifierMLP.TARGET_CLASSES
					prop_description = 'TARGET_CLASSES (query, stringlist) constructs the target classes which represent the class of each data point.';
				case NNClassifierMLP.LAYERS
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case NNClassifierMLP.TARGET_CLASSES % __NNClassifierMLP.TARGET_CLASSES__
