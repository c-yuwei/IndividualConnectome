		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case NNDataPoint_Measure_REG.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the data point for regression with graph measures.';
				case NNDataPoint_Measure_REG.NAME
					prop_description = 'NAME (constant, string) is the name of the data point for regression with graph measures.';
				case NNDataPoint_Measure_REG.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the data point for regression with graph measures.';
				case NNDataPoint_Measure_REG.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the data point for regression with graph measures.';
				case NNDataPoint_Measure_REG.ID
					prop_description = 'ID (data, string) is a few-letter code for the data point for regression with graph measures.';
				case NNDataPoint_Measure_REG.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the data point for regression with graph measures.';
				case NNDataPoint_Measure_REG.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the data point for regression with graph measures.';
