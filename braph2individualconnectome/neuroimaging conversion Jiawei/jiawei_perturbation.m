...
%% export st data
directory = [fileparts(which('jiawei_perturbation')) filesep 'Converted data structural T1w ROI ST'];
mkdir(directory);
file = [directory filesep 'group_subjects_GMV1830.xlsx'];
...
file = [directory filesep 'group_subjects_GMV3040.xlsx'];
ex = ExporterGroupSubjectST_XLS( ...
    'FILE', file, ...
    'GR', gr3040_st ...
    );
...
file = [directory filesep 'group_subjects_GMV4050.xlsx'];
ex = ExporterGroupSubjectST_XLS( ...
    'FILE', file, ...
    'GR', gr4050_st ...
    );
...
file = [directory filesep 'group_subjects_GMV5060.xlsx'];
ex = ExporterGroupSubjectST_XLS( ...
    'FILE', file, ...
    'GR', gr5060_st ...
    );
...
gr_con5060_pert = c5060.get('GR_CON');
...
gr_con4050_pert = c4050.get('GR_CON');
...
gr_con3040_pert = c3040.get('GR_CON');


%% export connectivity perturbation 
directory = [fileparts(which('jiawei_perturbation')) filesep 'Converted data structural T1w ROI perturbation'];
mkdir(directory);


directory1 = [directory filesep 'group_subjects_Pert3040'];
mkdir(directory1);
...
directory2 = [directory filesep 'group_subjects_Pert4050'];
mkdir(directory2);
ex = ExporterGroupSubjectCON_XLS( ...
...
directory3 = [directory filesep 'group_subjects_Pert5060'];
mkdir(directory3);
ex = ExporterGroupSubjectCON_XLS( ...
