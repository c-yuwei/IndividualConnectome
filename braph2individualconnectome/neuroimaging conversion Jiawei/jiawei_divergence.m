...
gr_div4050 = c4050.get('GR_CON');

%% export connectivity perturbation 
directory = [fileparts(which('jiawei_divergence')) filesep 'Converted data structural T1w ROI divergence'];
mkdir(directory);


directory1 = [directory filesep 'group_subjects_div3040'];
mkdir(directory1);
...
directory2 = [directory filesep 'group_subjects_div4050'];
mkdir(directory2);
ex = ExporterGroupSubjectCON_XLS( ...
...
directory3 = [directory filesep 'group_subjects_div5060'];
mkdir(directory3);
ex = ExporterGroupSubjectCON_XLS( ...
...
directory4 = [directory filesep 'group_subjects_div1830'];
mkdir(directory4);
ex = ExporterGroupSubjectCON_XLS( ...
