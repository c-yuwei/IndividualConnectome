...
directory = [fileparts(which('jiawei_distance')) filesep 'Converted data structural T1w ROI distance'];
mkdir(directory);


directory1 = [directory filesep 'group_subjects_dist3040'];
mkdir(directory1);
...
directory2 = [directory filesep 'group_subjects_dist4050'];
mkdir(directory2);
ex = ExporterGroupSubjectCON_XLS( ...
...
directory3 = [directory filesep 'group_subjects_dist5060'];
mkdir(directory3);
ex = ExporterGroupSubjectCON_XLS( ...
