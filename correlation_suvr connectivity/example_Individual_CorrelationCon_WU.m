...
% save('Results/matrix/nonconverters/classification_results_correlation_matrixClassification.mat', 'results');
% 
% %% Generate Boxplots for CN vs. MCI
% figure('Name', 'Performance Metrics of correlation for CN vs. MCI', 'NumberTitle', 'off');
% sgtitle('Performance Metrics of correlation for CN vs. MCI', 'FontSize', 14);
% 
% % AUC Boxplot
% subplot(1, 3, 1);
...
% figure('Name', 'Performance Metrics of correlation for CN vs. AD', 'NumberTitle', 'off');
% sgtitle('Performance Metrics of correlation for CN vs. AD', 'FontSize', 14);
% 
% % AUC Boxplot
% subplot(1, 3, 1);
...
save('Results/matrix/withConverters/classification_results_correlation_matrixClassification_Balanced.mat', 'results');
...
%% Generate Boxplots for CN vs. MCI
figure('Name', 'Performance Metrics of deviation for CN vs. MCI', 'NumberTitle', 'off');
sgtitle('Performance Metrics of deviation for CN vs. MCI', 'FontSize', 14);
