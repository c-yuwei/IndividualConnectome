%% ¡header!
ConstructorIndividualConPerturbation < ConstructorIndividualConBase (ipc, perturbation-based subject individual brain connectome Constructor) Construct perturbation-based brain connectome from subjects with SUVR data.
