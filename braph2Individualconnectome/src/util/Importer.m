classdef Importer < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'Importer'  'ImporterGroupSubjNIfTI'  'ImporterGroupSubjectCON_TXT'  'ImporterGroupSubjectCON_XLS'  'ImporterGroupSubjectFUN_TXT'  'ImporterGroupSubjectFUN_XLS'  'ImporterGroupSubjectST_TXT'  'ImporterGroupSubjectST_XLS'  'ImporterBrainAtlasTXT'  'ImporterBrainAtlasXLS'  'ImporterBrainSurfaceNV'  'ImporterPipelineBRAPH2' }; %CET: Computational Efficiency Trick
		end
