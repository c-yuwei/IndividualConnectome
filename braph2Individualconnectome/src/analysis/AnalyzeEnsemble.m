classdef AnalyzeEnsemble < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'AnalyzeEnsemble'  'AnalyzeEnsembleDivergence_FUN_WU'  'AnalyzeEnsemble_CON_WU'  'AnalyzeEnsemble_FUN_BUD'  'AnalyzeEnsemble_FUN_BUT'  'AnalyzeEnsemble_FUN_WU' }; %CET: Computational Efficiency Trick
		end
